...
def copy_partie(partie:dict)->dict:
    ...
    duree_totale = get_duree_totale(partie)
    temps_restant = get_temps_restant(partie)
    arene_copy = arene.copy_arene(get_arene(partie))

    return {"nom_partie": nom_partie,"duree_totale": duree_totale,"temps_restant": temps_restant,"arene": arene_copy}
