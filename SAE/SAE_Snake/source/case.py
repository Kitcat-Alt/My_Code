...
def copy_case(case:dict)->dict:
    ...
    """ 
    mur = est_mur(case)   
    valeur = get_val_boite(case)
    proprietaire = get_proprietaire(case)
    tps_restant = get_temps_restant(case)
    return {"mur":mur,"valeur":valeur,"proprietaire":proprietaire,"temps_restant":tps_restant}